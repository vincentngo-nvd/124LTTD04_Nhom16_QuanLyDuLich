...
public class tour_DatVe_DatCho_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tour_datve_datcho);
    ...
    private void setupClickListeners() {
        LinearLayout firstProduct = findViewById(R.id.first_product_thanhtoan);
    ...
    private void openDatChoActivity() {
        Intent intent = new Intent(tour_DatVe_DatCho_Activity.this, tour_DatVe_ChonSoLuongVe_Activity.class);
        startActivity(intent);
    }

    // Phương thức để mở giao diện activity_tour_chitiet.xml
    private void openDetailActivity() {
        Intent intent = new Intent(tour_DatVe_DatCho_Activity.this, tour_DatVe_ThanhToan_Activity.class);
        startActivity(intent);
    }
}
