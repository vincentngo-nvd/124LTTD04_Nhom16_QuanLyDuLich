...
public class hotel_CgrChoosePerson_Adapter extends ArrayAdapter<hotel_Category_Model> {
    public hotel_CgrChoosePerson_Adapter(@NonNull Context context, int resource, @NonNull List<hotel_Category_Model> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.hotel_item_chooseperson,parent,false);
